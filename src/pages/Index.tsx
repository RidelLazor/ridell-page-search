...
const Index = () => {
  ...
  const renderControls = (vertical = false) => (
    <div className={`flex ${vertical ? 'flex-col' : ''} items-center gap-3`}>
      ...
      <a
        ...
        className={`inline-flex items-center gap-2 px-5 py-2.5 rounded-full text-white font-medium text-sm shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 ${vertical ? 'w-full justify-center' : ''}`}
        style={{
    ...
    <div className="min-h-screen bg-background">
      ...
      {viewState === "results" && (
        <div className="flex min-h-screen">
          ...
          <aside className="hidden md:flex flex-col gap-4 p-4 w-16 border-r border-border bg-background/50">
            {renderControls(true)}
          </aside>
